...
export default function BrandLogo(){
  return (
    <Link to="/" className="brand-logo flex gap-3 items-center bg-gradient-to-r from-[#5372F0]/10 to-[#215BBF]/5 p-2 rounded-md border border-[#5372F0]/20" role="img" aria-label="BrazFlow logo">
